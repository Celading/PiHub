...
export const zhMessages = {
  ...
  'automation.modes': '引导/跟进模式',
  'automation.inSettings': '在设置中管理',
  'automation.automation.note': '实时开关位于 设置 → 通用 / 权限 / 实验室。',
...
export const enMessages: Record<MessageKey, string> = {
  ...
  'automation.modes': 'Steering / follow-up modes',
  'automation.inSettings': 'managed in Settings',
  'automation.automation.note': 'Live toggles live in Settings → General / Permissions / Lab.',
