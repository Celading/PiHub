...
export const zhMessages = {
  ...
  'automation.pipelines.note': '工程流（Pipelines）为 PiHub 独家编排功能，设计确认后在此呈现。',
...
export const enMessages: Record<MessageKey, string> = {
  ...
  'automation.pipelines.note': 'Pipelines is PiHub-exclusive orchestration — landing after design sign-off.',
